...
# Save plots to PDF
pdf("/home/claude/task1_part_a_plots.pdf", width = 12, height = 10)
...
pdf("/home/claude/task1_part_b_plots.pdf", width = 15, height = 10)
...
pdf("/home/claude/task1_part_c_comparison.pdf", width = 10, height = 8)
