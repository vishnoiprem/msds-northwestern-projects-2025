...
pdf("/home/claude/task2_part1_normal_medians.pdf", width = 12, height = 10)
...
pdf("/home/claude/task2_part1_uniform_medians.pdf", width = 12, height = 10)
par(mfrow = c(2, 2), mar = c(4, 4, 3, 2))
...
pdf("/home/claude/task2_part2_exponential.pdf", width = 14, height = 10)
...
pdf("/home/claude/task2_part3_comparison.pdf", width = 14, height = 10)
